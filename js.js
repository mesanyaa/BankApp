...
const account1 = {
  ...
  movementsDates: [
    ...
    "2024-02-11T17:01:17.194Z",
    "2024-02-12T23:36:17.929Z",
...
function formatMovementDate(date) {
  ...
  else if (daysPassed === 2) return "Позавчера";
  else if (daysPassed >= 2 && daysPassed <= 4)
    return `Прошло ${daysPassed} дня`;
  else if (daysPassed <= 7) return `Прошло ${daysPassed} дней`;
...
btnTransfer.addEventListener("click", function (e) {
  ...
  if (
    ...
    recieveAcc.movementsDates.push(date);
